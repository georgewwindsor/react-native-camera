...
RCT_EXPORT_VIEW_PROPERTY(onPixelsProcessed, RCTDirectEventBlock);
...
{
    return @[@"onCameraReady", @"onMountError", @"onBarCodeRead", @"onFacesDetected", @"onPictureSaved", @"onTextRecognized",@"onPixelsProcessed", @"onGoogleVisionBarcodesDetected"];
}
